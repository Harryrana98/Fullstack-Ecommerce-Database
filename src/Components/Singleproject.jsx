...
function Singleproject() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-purple-100 py-10">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 lg:p-10">
            ...
            <div className="space-y-6">
              {product.category && (
                <span className="inline-block px-3 py-1 text-sm font-semibold bg-blue-100 text-blue-700 rounded-full capitalize">
                  {product.category}
                </span>
              )}
              ...
              <div className="flex items-center space-x-3">
                <span className="text-3xl font-bold text-green-600 flex items-center">
                  <PiCurrencyDollarBold className="w-7 h-7 mr-1" />
                  {product.price}
                </span>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  ...
                  disabled={disabled}
                  className={`flex-1 flex items-center justify-center gap-2 py-3 px-6 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg ${
                    disabled
                ...
                <button
                  ...
                  className={`flex items-center justify-center gap-2 py-3 px-6 rounded-lg font-semibold border transition-all ${
                    isWishlisted
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 text-sm text-gray-600">
