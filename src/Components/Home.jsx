...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 py-10 mt-20">
        ...
        {displayProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {displayProducts.map((product) => (
              <div key={product._id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition overflow-hidden group">
                <Link to={`/product/${product._id}`}>
                  <div className="aspect-square p-4 bg-blue-50 flex items-center justify-center overflow-hidden">
                    <img
                      src={product.url}
                      alt={product.name}
                ...
                <div className="p-4">
                  <Link to={`/product/${product._id}`}>
                    <h3 className="font-semibold text-lg text-gray-900 mb-2 line-clamp-2 hover:text-blue-600">
